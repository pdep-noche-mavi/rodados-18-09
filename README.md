...
Se conoce a la municipalidad de Coronel Vallejos, que maneja un monto de caja y conoce a todas sus dependencias. En ocasiones, precisa plata, y entonces vende un rodado.
Para modelar esto, tengamos en cuenta que los rodados valen cada uno 100 mil pesos. Y cuidado! No pueden quedar dependencias con capacidad faltante si vendemos el rodado, no deberíamos poder venderlo si es así.
